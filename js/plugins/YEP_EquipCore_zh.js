...
Window_EquipCommand.prototype.addFinishCommand = function() {
    ...
    this.addCommand(Yanfly.Param.EquipFinishCmd, '取消');
};
...
Window_StatCompare.prototype.drawCurrentParam = function(y, paramId) {
    ...
    this.drawText(actorparam, x, y, this._paramValueWidth, '右');
};
...
Window_StatCompare.prototype.drawParamDifference = function(y, paramId) {
    ...
    this.drawText(text, x, y, this._bonusValueWidth, '左');
};
...
Scene_Equip.prototype.createCommandWindow = function() {
    ...
    this._commandWindow.setHandler('装备', this.commandEquip.bind(this));
    this._commandWindow.setHandler('最优化', this.commandOptimize.bind(this));
    this._commandWindow.setHandler('clear', this.commandClear.bind(this));
    this._commandWindow.setHandler('取消', this.popScene.bind(this));
    this._commandWindow.setHandler('下一页', this.nextActor.bind(this));
    this._commandWindow.setHandler('上一页', this.previousActor.bind(this));
...
Scene_Equip.prototype.createSlotWindow = function() {
    ...
    this._slotWindow.setHandler('确定',       this.onSlotOk.bind(this));
    this._slotWindow.setHandler('取消',   this.onSlotCancel.bind(this));
...
Scene_Equip.prototype.createItemWindow = function() {
    ...
    this._itemWindow.setHandler('确定',     this.onItemOk.bind(this));
    this._itemWindow.setHandler('取消', this.onItemCancel.bind(this));
...
Scene_Equip.prototype.updateLowerRightWindowTriggers = function() {
    ...
    if (Input.isRepeated('右')) {
      this.shiftLowerRightWindows();
    } else if (Input.isRepeated('左')) {
